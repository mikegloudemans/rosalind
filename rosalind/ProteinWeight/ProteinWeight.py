...
# NOTE: Thanks to Patrick Gaskill on the Rosalind.com problem "Inferring mRNA from protein" for inspiring this approach
with a similar technique used for that problem.
'''
...
def weight(protein):
    ...
    weight = sum(map(weightMap.get, protein))
    return weight
